...
Before Microsoft added it to the programs/commands supplied as standard with MS-Dos, I must have needed to delete a tree of files and folders.

Rather than do it by hand, I made myself a program wisely called “deltree”.

Coded in [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal) in 1991, this command was of little use once MS-Dos was released, and even less so under Windows, where early versions of the file explorer were still usable.
